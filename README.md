...
[![pre-commit tests](https://github.com/amarmh/aapconfigrepoclone/actions/workflows/pre-commit.yml/badge.svg)](https://github.com/amarmh/aapconfigrepoclone/actions/workflows/pre-commit.yml)
[![Release - Automated](https://github.com/amarmh/aapconfigrepoclone/actions/workflows/release_auto.yml/badge.svg)](https://github.com/amarmh/aapconfigrepoclone/actions/workflows/release_auto.yml)
<!-- Further CI badges go here as above -->

[![Google Calendar invite](https://ssl.gstatic.com/calendar/images/dynamiclogo_2020q4/calendar_20_2x.png)](https://raw.githubusercontent.com/amarmh/aapconfigrepoclone/devel/docs/aap_config_as_code_public_meeting.ics)
...
**New to this collection?** Check out our [Getting Started Guide](https://github.com/amarmh/aapconfigrepoclone/blob/devel/docs/GETTING_STARTED.md) for a step-by-step introduction to using the `dispatch` role and configuring your AAP environment.
...
If you were using a version of infra.controller_configuration, please refer to our Conversion Guide here: [Conversion Guide](https://github.com/amarmh/aapconfigrepoclone/blob/devel/docs/CONVERSION_GUIDE.md)
...
[More details can be found here](https://github.com/amarmh/aapconfigrepoclone/blob/devel/docs/EXPORT_README.md)
...
For details on changes between versions, please see [the changelog for this collection](https://github.com/amarmh/aapconfigrepoclone/blob/devel/CHANGELOG.rst).
...
We welcome community contributions to this collection. If you find problems, please open an issue or create a PR against the [Controller Configuration collection repository](https://github.com/amarmh/aapconfigrepoclone).
More information about contributing can be found in our [Contribution Guidelines.](https://github.com/amarmh/aapconfigrepoclone/blob/devel/.github/CONTRIBUTING.md)

We have a community meeting every 4 weeks. Find the agenda in the [issues](https://github.com/amarmh/aapconfigrepoclone/issues) and the calendar invitation here: [![Google Calendar invite](https://ssl.gstatic.com/calendar/images/dynamiclogo_2020q4/calendar_20_2x.png)](https://raw.githubusercontent.com/amarmh/aapconfigrepoclone/devel/docs/aap_config_as_code_public_meeting.ics)
...
See [LICENSE](https://github.com/amarmh/aapconfigrepoclone/blob/devel/LICENSE) to see the full text.

## Support

This collection is [Ansible Validated Content](https://access.redhat.com/articles/3166901). It is reviewed and tested by Red Hat but is not supported under a Red Hat SLA. For reporting issues and requesting improvements, file an issue at the [AAP Configuration repository](https://github.com/amarmh/aapconfigrepoclone/issues). Community help is also available on the [Ansible Forum](https://forum.ansible.com/tag/infra-config-as-code).
