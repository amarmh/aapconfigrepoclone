...
File name: [configure_aap.yml](https://github.com/amarmh/aapconfigrepoclone/blob/devel/playbooks/configure_aap.yml) can be found in the top level playbooks directory.
